                          ...
                          <span className="token-contract-details h5">
                            <a href={"https://etherscan.io/token/" + address} target="_blank">
                              <span >
                                ...
                                Binance smart chain : {(address).slice(0, 4) + "..." + (address).slice(address.length - 4, address.length)}
                              </span>
                            </a>&nbsp;
                        ...
                        <div className="row">
                            ...
                            <div className="token_left_border">
                              ...
                              {/*                                   
                                  <div className="token_list_values">
                                    ...
                                    <h5>{token_max_supply ? separator(token_max_supply) : "-"}</h5>
                                  </div> */}
                            </div>
                          </div>
                          <div className="col-md-4 col-6">
                            <div className="token_left_border">
                              ...
                              {/* <div className="token_list_values">
                                    ...
                                    <h5>${market_cap ? separator(market_cap.toFixed(4)) : "NA"}</h5>
                                  </div>
                                  <div className="token_list_values">
                                    <h4>24H Volume / Market Cap</h4>
                                    <h5>${contract_24h_volume ? separator(contract_24h_volume.toFixed(2)) : "NA"}</h5>
                                  </div> */}
                          ...
                          <div className="col-md-4 col-sm-12 col-12">
                            <div className="token_left_border">
                              ...
                              {/* <div className="token_list_values">
                                      <h4>Liquidity</h4>
                                      <h5>${liquidity ? separator(liquidity.toFixed(4)) : null}</h5>
                                    </div>
                                    <div className="token_list_values">
                                      <h4>Token Type</h4>
                                      <h5>BEP20</h5>
                        ...
                        <tbody>
                          {
                            exchangelistnew.map((e, i) => {
                              return <tr key={i}>
                                <td title={e.exchange_address}>{e.exchange_name.replace(/([<>])/g, '')}</td>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-8">
                          <div className="input-group">
                            ...
                            <input type="text" id="referral-link" className="form-control" value={market_coinpedia_url + "bsc/" + contract_address} readOnly />
                          ...
                          <p className="share_social">
                            <a href={"https://www.facebook.com/sharer/sharer.php?u=" + market_coinpedia_url + "token/" + contract_address} target="_blank"><img src="/assets/img/facebook.png" width="100%" height="100%" /></a>
                            <a href={"https://www.linkedin.com/shareArticle?mini=true&url=" + market_coinpedia_url + "token/" + contract_address} target="_blank"><img src="/assets/img/linkedin.png" width="100%" height="100%" /></a>
                            <a href={"http://twitter.com/share?text=" + market_coinpedia_url + "token/" + contract_address} target="_blank"><img src="/assets/img/twitter.png" width="100%" height="100%" /></a>
                            <a href={"https://wa.me/?text=" + market_coinpedia_url + "token/" + contract_address} target="_blank"><img src="/assets/img/whatsapp.png" width="100%" height="100%" /></a>
                          </p>
                        </div>
                      </div>
