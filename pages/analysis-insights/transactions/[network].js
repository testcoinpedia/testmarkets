...
import {API_BASE_URL, convertvalue, config, graphqlApiKEY,market_coinpedia_url,separator} from '../../../components/constants'
...
{ 
    ...
    const complete_url = market_coinpedia_url+get_path
