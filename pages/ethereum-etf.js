...
export default function ETFEthereum({userAgent })
{ 
    const { active_currency } = useSelector(state => state)
    const myRef = useRef(null)
    const [ethereum_etf_list, set_ethereum_etf_list] = useState([]) 
    ...
    {   
        const res = await Axios.get(API_BASE_URL+"markets/exchange_traded_funds/list/0/50?network_type=2", config(""))
        const res2 = await Axios.get(API_BASE_URL+"markets/exchange_traded_funds/list/0/50?network_type=1", config(""));
        if (res.data) {
...
return (
   <>
      <Head>
         ...
         <title>Ethereum ETF Tracker: Real-Time Updates and Insights  | Coinpedia</title>
         <meta name="description" content="Explore the Ethereum ETF market with our real-time tracker. Get up-to-date insights on pricing, trends, and performance analysis."/>
         <meta name="keywords" content="Ethereum ETF Tracker, Ethereum ETF Explorer, Ethereum ETF marketplace, E muerehtETF Live Data, Ethereum ETF insights." />
         <meta property="og:locale" content="en_US" />
         <meta property="og:type" content="website" />
         <meta property="og:title" content="Ethereum ETF Tracker: Real-Time Updates and Insights  | Coinpedia" />
         <meta property="og:description" content="Explore the Ethereum ETF market with our real-time tracker. Get up-to-date insights on pricing, trends, and performance analysis." />
         <meta property="og:url" content={market_coinpedia_url + "ethereum-etf/"} />
         ...
         <meta name="twitter:title" content="Ethereum ETF Tracker: Real-Time Updates and Insights  | Coinpedia" />
         <meta name="twitter:description" content="Explore the Ethereum ETF market with our real-time tracker. Get up-to-date insights on pricing, trends, and performance analysis." />
         <meta name="twitter:image" content="http://image.coinpedia.org/wp-content/uploads/2020/08/19142249/cp-logo.png" /> 

         <link rel="canonical" href={market_coinpedia_url + "ethereum-etf/"} />

         <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{"@context":"http://schema.org","@type":"Table","about":"Ethereum ETF Tracker"}`,
          }}
        />
            ...
            __html: `{
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": "https://markets.coinpedia.org/ethereum-etf/"
                }
              ]
            }`,
          }}
          ...
          <div className="container">
            <div className="col-md-12">
              <div className="row market_insights ">
                ...
                <h1 className="page_title">Ethereum ETF Tracker</h1>
                  {/* by Market Cap */}
                  <p>Ethereum ETF Tracker: Real-time updates, market trends, and performance insights.</p>
                </div>
             ...
             <div className="etf_overview_block">
                <div className="row">
                  ...
                  <div className='col-8 col-md-8'>
                    ...
                    <ul>
                        ...
                        <li>
                        <p><span>
                          <img src="/assets/img/bitcoin_etf.svg" alt="Bitcoin" title="Bitcoin" /></span> &nbsp; {count2}
                          </p>
                        </li>
                  </ul>
                    </div>
                ...
                <div className='total_etfs_count'>
                      <p>Total Running Ethereum ETF</p>
                    </div>
             </div>
                            ...
                            {/* <th className="mobile_fixed_first" style={{minWidth: '35px'}}></th> */}
                                ...
                                <OverlayTrigger
                                    delay={{ hide: 450, show: 300 }}
                                      overlay={(props) => (
                                        <Tooltip {...props} className="custom_pophover">
                                          <p>This typically refers to the total market value of all the Ethereum (ETH) held by the ETF.</p>
                                        </Tooltip>
                                      )}
                                      placement="bottom"
                                    ><span className='info_col' ><img src="/assets/img/info.png" alt="info" /></span>
                                ...
                                <OverlayTrigger
                                    delay={{ hide: 450, show: 300 }}
                                      overlay={(props) => (
                                        <Tooltip {...props} className="custom_pophover">
                                          <p>This represents the total amount of Ethereum ETF shares traded within the past 24 hours.</p>
                                        </Tooltip>
                                      )}
                                      placement="bottom"
                                    ><span className='info_col' ><img src="/assets/img/info.png" alt="info" /></span>
                                ...
                                <OverlayTrigger
                                    delay={{ hide: 450, show: 300 }}
                                      overlay={(props) => (
                                        <Tooltip {...props} className="custom_pophover">
                                          <p>This specifies the financial institution responsible for safeguarding the underlying Ethereum assets of the ETF. </p>
                                        </Tooltip>
                                      )}
                                      placement="bottom"
                                    ><span className='info_col' ><img src="/assets/img/info.png" alt="info" /></span>
                                    ...
                                    <td className=" mobile_fixed_first"> {sl_no+i+1}
                                     ...
                                     <td>  {e.status == "Running" ? 
                                      <p className='running_status'>{e.status}</p> 
                                       : <p className='pending_status'>{e.status}</p> } {e.type}</td>
