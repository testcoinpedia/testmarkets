                       ...
                       <table className="table table-borderless">
                         <thead>
                            ...
                            <tr>
                                ...
                                <th className="mobile_hide_table_col" style={{minWidth: '34px'}}>Sl.No</th>
                         ...
                         <tbody>
                           ...
                           <>
                           {
                             ...
                             <tr key={i}>
                                     ...
                                     <span className=" wishlist"> {sl_no+i+1}</span>
                                     {/* {
                                       user_token ?
                                       <>
                                       {
                                         ...
                                         <a>
                                          <div className="media">
                                            <div className="media-left">
                                              <img src={image_base_url+(e.coinmarketcap_id ? e.coinmarketcap_id+".png":"")} onError={(e) =>e.target.src = "/assets/img/default_token.png"} alt={e.token_name} width="100%" height="100%" className="media-object" />
                                            </div>
                                    ...
                                    <td className="mobile_hide_table_col">
                                     ...
                                     {/* <td className="mobile_hide_table_col">
                                       <Link href={"/"+e.token_id}>
                                         <a>
                                           {e.total_supply ? separator(e.total_supply) : "-"} 
                                         </a>
                                       </Link>
                                    </td> */}
                                     <td className="mobile_hide_table_col">
