...
{ 
    ...
    {  
        ...
        const res = await Axios.get(API_BASE_URL+"markets/cryptocurrency/stable-coins/"+current_pages+'/'+per_page_count+"?search="+search_title+"&category_row_id="+category_row_id, config(JsCookie.get('user_token')))
        if(res.data)
        {
...
return (
   <>
      <Head>
         ...
         <title>All Stable Coins | Track Live Price </title>
         <meta name="description" content="Explore the world of stablecoins, track price, and learn valuable information to help you navigate the stablecoin market"/>
         <meta name="keywords" content="coinpedia markets, stablecoins, all stablecoins, stablecoins in crypto, best stale, USDT, USDC, BUSD, DAI, TUSD, Tether USD, USDD, USDP, crypto price, bitcoin price, Ethereum price, live crypto news" />
         <meta property="og:locale" content="en_US" />
         <meta property="og:type" content="website" />
         <meta property="og:title" content="All Stable Coins | Track Live Price" />
         <meta property="og:description" content="Explore the world of stablecoins, track price, and learn valuable information to help you navigate the stablecoin market " />
         <meta property="og:url" content={market_coinpedia_url + "stable-coins/"} />
         ...
         <meta name="twitter:title" content="All Stable Coins | Track Live Price" />
         <meta name="twitter:description" content="Explore the world of stablecoins, track price, and learn valuable information to help you navigate the stablecoin market" />
         <meta name="twitter:image" content="http://image.coinpedia.org/wp-content/uploads/2020/08/19142249/cp-logo.png" /> 

         <link rel="canonical" href={market_coinpedia_url + "stable-coins/"} />
         <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{"@context":"http://schema.org","@type":"Table","about":"Stable Coins"}`,
          }}
        />
        <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "position": 2,
                  "name": "Stable Coins",
                  "item": "https://markets.coinpedia.org/stable-coins/"
                }
              ]
            }`,
          }}
            ...
            <div className="col-md-12">
              <div className="row market_insights ">
                <div className="col-md-6 col-lg-6">
                  <h1 className="page_title">Stable Coins</h1>
                  {/* by Market Cap */}
                  <p>Discover and track stable coins, listed as per their market cap</p>
                </div>
...
<div className="all-categories-list ">
  <CategoriesTab active_tab={4} user_token={user_token}/> 
</div>
                ...
                <div className="row">
                  ...
                  <div className="row">
                      <div className="col-md-12 col-lg-9 col-12">
                        <h4 className="markets_subtitle">Stable Coins</h4>
                      </div>
