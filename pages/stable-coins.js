...
{ 
    ...
    {  
        ...
        const res = await Axios.get(API_BASE_URL+"markets/cryptocurrency/stable-coins/"+current_pages+'/'+per_page_count+"?search="+search_title+"&category_row_id="+category_row_id, config)
        if(res.data)
        {
...
return (
   <>
      <Head>
         <title>Stable Coins & Tokens | Coinpedia </title>
         ...
         <meta property="og:title" content="Stable Coins & Tokens | Coinpedia" />
         ...
         <meta name="twitter:title" content="Stable Coins & Tokens | Coinpedia" />
            ...
            <div className="col-md-12">
              <div className="row market_insights ">
                <div className="col-md-6 col-lg-6">
                  <h1 className="page_title">Stable Coins & Tokens</h1>
                  {/* by Market Cap */}
                  <p>This page lists the most valuable stablecoins. They are listed by market cap with the largest first and then descending in order.</p>
                </div>
                                     ...
                                     
                                     {
                                        user_token ?
                                          <>
                                          {
                                            ...
                                            :
                                            <span onClick={()=>addToWatchlist(e._id)} ><img src="/assets/img/wishlist_star.svg" alt="Watchlist" width={17} height={17} /></span>
                                            }
                                          </>
                                          :
                                          <Link href={app_coinpedia_url+"login?prev_url="+market_coinpedia_url} onClick={()=> Logout()}><img src="/assets/img/wishlist_star.svg" alt="Watchlist"/></Link>
                                      }
