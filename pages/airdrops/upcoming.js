...
export default function MyFunction() 
{
  ...
  const getICOList = async () => 
  {
    ...
    const res = await Axios.get(API_BASE_URL+"markets/airdrops/upcoming/0/100"+"?search="+search_value+"&search_networks="+search_networks, config(""))
    if(res.data.status) 
    {   
  ...
  return (
        ...
        <Head>
         ...
         <title>Upcoming Crypto Airdrops</title>
         <meta name="description" content="List of verified and upcoming crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links."/>
         <meta name="keywords" content={"Airdrop, crypto airdrops "+moment().format('MMMM YYYY')+" , new airdrop, upcoming airdrops, airdrops, crypto airdrop, crypto airdrops, best crypto airdrops, latest airdrops, latest crypto airdrop, NFT airdrops"} />
         <meta property="og:locale" content="en_US" />
         <meta property="og:type" content="website" />
         <meta property="og:title" content="Upcoming Crypto Airdrops" />
         <meta property="og:description" content="List of verified and upcoming crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links." />
         <meta property="og:url" content={market_coinpedia_url+"airdrops/upcoming/"} />
         ...
         <meta name="twitter:title" content="Upcoming Crypto Airdrops" />
         <meta name="twitter:description" content="List of verified and upcoming crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links." />
         <meta name="twitter:image" content="http://image.coinpedia.org/wp-content/uploads/2020/08/19142249/cp-logo.png" /> 

         <link rel="canonical" href={market_coinpedia_url+"airdrops/upcoming/"}/>
         <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{"@context":"http://schema.org","@type":"Table","about":"Upcoming Crypto Airdrops"}`,
          }}
        />
            ...
            __html: `{
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Upcoming Crypto Airdrops",
                  "item": "https://markets.coinpedia.org/airdrops/upcoming/"
                }
              ]
            }`,
          }}
    ...
    <div className="page airdrop_page ico_calendar">
        <Airdrops_header active_tab={2} overview_counts={overview_counts}/>
            ...
            <div className=''>
                <div className='row'>
                {
                        ...
                        <div className='col-md-12 text-center'>
                            Currently, We don't have any Upcoming Airdrops in our Listing..
                        </div>
                        </>
                         :
                        <>
