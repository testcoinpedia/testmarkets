...
export default function MyFunction({user_token}) 
{
  ...
  const getICOList = async () => 
  {
    ...
    const res = await Axios.get(API_BASE_URL+"markets/airdrops/active/0/100"+"?search="+search_value+"&search_networks="+search_networks, config(""))
    if(res.data.status) 
    {   
  ...
  return (
        ...
        <Head>
         ...
         <title>{"Crypto Airdrops "+moment().format('MMMM YYYY')}</title>
         <meta name="description" content="List of verified and active crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links. "/>
         ...
         <meta property="og:title" content={"Crypto Airdrops "+moment().format('MMMM YYYY')} />
         <meta property="og:description" content="List of verified and active crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links. " />
         <meta property="og:url" content={market_coinpedia_url+"airdrops/"} />
         ...
         <meta name="twitter:title" content={"Crypto Airdrops "+moment().format('MMMM YYYY')} />
         <meta name="twitter:description" content="List of verified and active crypto airdrops and NFT Airdrops, listed on Coinpedia. Find Airdrop details with direct participation links. " />
         <meta name="twitter:image" content="http://image.coinpedia.org/wp-content/uploads/2020/08/19142249/cp-logo.png" /> 

         <link rel="canonical" href={market_coinpedia_url+"airdrops/"}/>
         <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{"@context":"http://schema.org","@type":"Table","about":"Crypto Airdrops"}`,
          }}
        />
            ...
            __html: `{
              ...
              "itemListElement": [
                ...
                },
                {
                  ...
                  "item": "https://markets.coinpedia.org/airdrops/"
                }
              ]
            }`,
          }}
    ...
    <div className="page airdrop_page ico_calendar">
        <Airdrops_header active_tab={1} overview_counts={overview_counts}/>
            ...
            <div className='container'>
                <div className='row'>
                {
                        ...
                        <div className="col-md-4">
                            <div className="airdrop_block">
                                ...
                                <div className="row mt-4">
                                    ...
                                    <div className="col-md-6 col-6">
                                        <div className="sub_airdrop">
                                            <p className="sub_title"><img src="/assets/img/medal.svg" alt="Medal" style={{width:"15px"}}  /> Winner </p>
                        ...
                        <div className='col-md-12 text-center'>
                            Currently, We don't have any Active Airdrops in our Listing..
                        </div>
                        </>
                         :
                        <>
...
{/* // startTime="10:15"
// endTime="23:30"
// buttonStyle="custom" // default, 3d, flat, round, neumorphism, text, date, custom, none
// inline="true"
// buttonsList="false"
// label="Calendar"
// trigger="click" // hover, click
// listStyle="overlay" // dropdown, dropdown-static, overlay, modal
// hideBackground="true"
...
// hideCheckmark="true"
// size="3|2|1"
// lightMode="bodyScheme" // system, dark, light, bodyScheme
// language="en" // en, de, nl, fr, es, pt, tr, zh, ar, hi, pl, id, no, fi, sv, cs, ja, it, ko, vi
// customLabels="{}"
// images="/assets/img/calendar.svg" // array of URLs
// hideRichData="false"
// identifier="calendar-button"
