...
export default function MyFunction({user_token}) 
{
  ...
  const getICOList = async () => 
  {
    ...
    const res = await Axios.get(API_BASE_URL+"markets/launchpads/ended/0/100"+"?search="+search_value+"&search_networks="+search_networks, config(""))
    if(res.data.status) 
    {   
  ...
  return (
        ...
        <Head>
         ...
         <title>CoinPedia’s List Of Completed Coin/Token Launches  </title>
         <meta name="description" content="Find completed crypto ICO, IDE, IEO, IGO, and Presales, verified by CoinPedia. Get details and direct links to the project. "/>
         <meta name="keywords" content={"completed icos, completed presales, next presales, Coinpedia coin launch calendar, coin launch, ico calendar, best crypto icos,  ICO, IDE, IEO, IGO, Presales, crypt "+moment().format('YYYY')+", crypto news, crypto launchpad, best crypto to buy, new presales."} />
         <meta property="og:locale" content="en_US" />
         <meta property="og:type" content="website" />
         <meta property="og:title" content="CoinPedia’s List Of Completed Coin/Token Launches " />
         <meta property="og:description" content="Find completed crypto ICO, IDE, IEO, IGO, and Presales, verified by CoinPedia. Get details and direct links to the project. " />
         ...
         <meta name="twitter:title" content="CoinPedia’s List Of Completed Coin/Token Launches " />
         <meta name="twitter:description" content="Find completed crypto ICO, IDE, IEO, IGO, and Presales, verified by CoinPedia. Get details and direct links to the project. " />
         <meta name="twitter:image" content="http://image.coinpedia.org/wp-content/uploads/2020/08/19142249/cp-logo.png" /> 

         
         <script type="application/ld+json"  
          dangerouslySetInnerHTML={{
            __html: `{"@context":"http://schema.org","@type":"Table","about":"Completed Coin Launches"}`,
          }}
        />
            ...
            __html: `{
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Completed Coin Launches",
                  "item": "https://markets.coinpedia.org/launchpad/ended/"
                }
              ]
            }`,
          }}
    ...
    <div className="page ico_calendar">
        <ICO_header active_tab={3} overview_counts={overview_counts}/>
                    ...
                    <div className='col-md-2 col-xl-2 col-lg-2 col-4'>
                        {
                          ...
                          <div className='launchpad-button-section'>
                            <Link href="/token" className='create-launchpad button_transition'>Create Launchpad</Link>
                          </div>
                          :
                          <div className='launchpad-button-section'>
                          <a  className='create-launchpad button_transition' onClick={()=>loginModalStatus()}>Create Launchpad</a>
                          </div>
                        }
                    </div>
                    <div className='col-md-4 col-xl-3 col-lg-3 col-8'>
            ...
            <div className=''>
                <div className='row'>
                {
                        ...
                        <div className='col-md-12 text-center'>
                            Currently, We don't have any Ended ICO's in our Listing..
                        </div>
                        </>
                         :
                        <>
