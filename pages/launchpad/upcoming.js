...
export default function UpcomingLaunchPad({userAgent}) { 
  ...
  const GetAllUpcoming = ()=>{ 
    Axios.get(API_BASE_URL+"markets/launchpads/upcoming", config(""))
    .then(response=>{
                   ...
                   {     
                      upcoming.length > 0 ?
                        ...
                        <tr key={i}>
                          ...
                          <td className="table_date"><p>{moment.utc(e.start_date).format('ll')}</p></td>
                          <td className="table_date"><p>{moment.utc(e.end_date).format('ll')}</p></td>
                        </tr>
                            ...
                            <>
                         {
                           apistatus ?
                           <tr key="1">
                             <td className="text-center no_data_found" colSpan="6">
