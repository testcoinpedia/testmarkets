                       ...
                       <table className="table table-borderless">
                         <thead>
                            <tr>
                                ...
                                <th className="mobile_hide_table_col" style={{minWidth: 'unset'}}>Gainers-Losers Number</th>
                                <th className="mobile_hide_table_col text-center">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                           {
                                    ...
                                    <td>
                                       <Link href={"/category/"+e.category_id}>
                                          ...
                                          <div className="media">
                                            ...
                                            <div className="media-body">
                                              <h4 className="media-heading mt-0">{e.token_gainer.token_name} <span>{(e.token_gainer.symbol)?.toUpperCase()}</span></h4>
                                              {
