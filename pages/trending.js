...
{ 
    ...
    {  
        ...
        const res = await Axios.get(API_BASE_URL+"markets/cryptocurrency/trending/"+current_pages+'/'+per_page_count+"?search="+search_title+"&category_row_id="+category_row_id, config)
        if(res.data)
        {
          ...
          <div className="container">
            <div className="col-md-12">
              <div className="row market_insights ">
                ...
                <h1 className="page_title">Trending Coins & Tokens</h1>
                  {/* by Market Cap */}
                  <p>Trending Coins & Tokens by Market Cap.</p>
                </div>
