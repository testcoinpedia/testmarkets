...
{   
   ...
   //3e314c7a-7a9c-40a7-8e37-8a83fed5bb18
    const tokenQuery = await fetch("https://pro-api.coinmarketcap.com/v2/cryptocurrency/ohlcv/historical?CMC_PRO_API_KEY=e671363b-4b20-42d7-80fe-32fb2ee8a88b&symbol="+symbol+"&count="+count+"&interval="+intervals, req_config)
    if(tokenQuery) 
    {    
