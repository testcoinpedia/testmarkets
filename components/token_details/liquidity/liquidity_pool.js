...
{   
    ...
    {   
        ...
        {   
            ...
            {   
                if(check_in_array.includes(pass_obj.network_row_id))
                {
                    const network_row_id = pass_obj.network_row_id
                    const contract_address = pass_obj.contract_address
                    ...
                    {   
                        ...
                        {   
                            ...
                            {   
                                ...
                                {
                                    const addr_balance_array = await filter_data[0].balances.filter(function (el) { return el.currency.address == contract_address.toLowerCase()})
    ...
    {
       const response = await Axios.post("/api/liquidity/addresses/", {token_id, addresses:pass_data})
                        ...
                        <tr>
                            ...
                            <div className="media mb-2">
                                <div className="media-left mr-0">
                                    <img className="media-object" style={{width:"25px"}} src={( token_image ? image_base_url+token_image:image_base_url+"default.svg")} onError={(e) =>e.target.src = "/assets/img/default_token.png"} />
                                </div>
