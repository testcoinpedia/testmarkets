...
export class TVChartContainer extends React.PureComponent 
{
	...
	{	
		...
		const widgetOptions = {
			...
			datafeed: Datafeed({symbol, liquidity_row_id, network_row_id, liquidity_address, contracts_array}),
	...
	render() {
		return (	
			<>
				<div ref={this.ref} className={styles.TVChartContainer+" trading-view__container"}  />
			</>
		)
	}
}