    ...
    <>
      <div className="market_top_header">
                          ...
                          login_dropdown == 1
                            ...
                            <div className="dropdown connect_wallet_header">
                              ...
                              <div className="dropdown-menu dropdown_wallet_header" aria-labelledby="2">
                                ...
                                <a className="dropdown-item manual_login_reg" href={app_coinpedia_url + "login?prev_url="+current_page_url}><img src="/assets/img/menu-login-img.svg" className="dark-menu-img" /><img src="/assets/img/menu-login-img.svg" className="light-menu-img" /> Manual Login</a>
        ...
        <nav className="navbar navbar-expand-lg  navbar-transparent navbar_border_bottom navbar_menu_items">
          <div className="container container_nav_pad">
                    ...
                    login_dropdown == 1
                      ...
                      <li className="dropdown mobile_after_login_block">
                        ...
                        <ul className="dropdown-menu">
                          ...
                          <li><a href={events_coinpedia_url + "my-events"} className="dropdown-item"><img src="/assets/img/menu-company.svg" /> Manage Events</a></li>
                        </ul>
                      </li>
                      :
