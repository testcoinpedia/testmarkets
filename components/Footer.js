   ...
   return(
      ...
      <footer id="footer" className="site-footer dark-skin dark-widgetized-area">
         ...
         <div className="sticky_footer_menu">
            <ul>
               <li className="footer_menu_items"><a href="https://afterinvest.com/"><img src="https://image.coinpedia.org/wp-content/uploads/2021/10/25180325/home.svg" /><span>Home</span></a></li>
               <li className="footer_menu_items"><a href="https://markets.afterinvest.com/"><img src="https://image.coinpedia.org/wp-content/uploads/2021/10/25180327/market.svg" /><span>Market</span></a></li>
               <li className="center_fixed_menu_img"><div className="col-md-12"><img src={favicon} /></div></li>
               <li className="footer_menu_items"><a href="https://afterinvest.com/"><img src="https://image.coinpedia.org/wp-content/uploads/2021/10/25180329/news.svg" /><span>News</span></a></li>
               <li className="footer_menu_items"><a href="https://app.afterinvest.com/"><img src="https://image.coinpedia.org/wp-content/uploads/2021/10/25180331/portfolio.svg" /><span>Portfolio</span></a></li>
            </ul>
         </div>
                     ...
                     <ul className="social-icons">
                        <li className="social-icons-item">
                           <a className="social-link rss-social-icon" rel="external noopener nofollow" target="_blank" href="https://coinpedia.org/feed/">
                              <img src="/assets/img/footer-rss.svg" />
                           </a>
                        </li>
                        <li className="social-icons-item">
                        ...
                        <li className="social-icons-item">
                           <a className="social-link pinterest-social-icon" rel="external noopener nofollow" target="_blank" href="https://pin.it/2Dwfamj">
                              <img src="/assets/img/footer-pinterest.svg" />
                           </a>
                        </li>
                        <li className="social-icons-item">
                        ...
                        <li className="social-icons-item">
                           <a className="social-link reddit-social-icon" rel="external noopener nofollow" target="_blank" href="https://www.reddit.com/user/Coinpedia_news">
                              <img src="/assets/img/footer-reddit.svg" />
                           </a>
                        </li>
                        <li className="social-icons-item">
                        ...
                        <li className="social-icons-item">
                           <a className="social-link medium-social-icon" rel="external noopener nofollow" target="_blank" href="https://coinpedianews.medium.com/">
                              <img src="/assets/img/footer-medium.svg" />
                           </a>
                        </li>
                        <li className="social-icons-item">
                           <a className="social-link telegram-social-icon" rel="external noopener nofollow" target="_blank" href="https://t.me/CoinpediaMarket">
                              <img src="/assets/img/footer-telegram.svg" />
                           </a>
                        </li>
                     </ul>
                  </div> 
