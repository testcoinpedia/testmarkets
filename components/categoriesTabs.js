            ...
            <div className="categories__container">
              <div className="row">
                <div className="markets_list_quick_links">
                  ...
                  <li>
                    <Link href={"/gainers-and-losers/?active_category=3"}> 
                      <a data-toggle="tab"  className={"nav-item nav-link categories__item "+(tab_status_connections === 3 ? "active_category":"")} onClick={()=>set_tab_status_connections(3)}>Gainers & Losers</a>
                    </Link>
                  </li>
                  ...
                  <li  data-toggle="modal" data-target="#comingSoon">
                    <a data-toggle="tab"   className={"nav-item nav-link categories__item "} >NFT Marketplace</a>
                  </li>                  
                  </ul>
                </div>
              </div>
